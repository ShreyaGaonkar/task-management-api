...
CREATE TABLE [ProjectTasks] (
    ...
    CONSTRAINT [FK_ProjectTasks_Users_AssignedByUserId] FOREIGN KEY ([AssignedByUserId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_ProjectTasks_Users_AssignedToUserId] FOREIGN KEY ([AssignedToUserId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [TaskDocuments] (
    ...
    CONSTRAINT [FK_TaskDocuments_ProjectTasks_TaskId] FOREIGN KEY ([TaskId]) REFERENCES [ProjectTasks] ([Id]) ON DELETE CASCADE,
...
CREATE TABLE [TaskNotes] (
    ...
    CONSTRAINT [FK_TaskNotes_ProjectTasks_TaskId] FOREIGN KEY ([TaskId]) REFERENCES [ProjectTasks] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_TaskNotes_Users_AddedByUserId] FOREIGN KEY ([AddedByUserId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION
);
GO

CREATE INDEX [IX_ProjectTasks_AssignedByUserId] ON [ProjectTasks] ([AssignedByUserId]);
GO

CREATE INDEX [IX_ProjectTasks_AssignedToUserId] ON [ProjectTasks] ([AssignedToUserId]);
GO
...
VALUES (N'20240713192846_Initial_Migration', N'6.0.0');
GO
